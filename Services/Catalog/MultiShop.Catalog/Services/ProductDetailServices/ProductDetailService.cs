...
namespace MultiShop.Catalog.Services.ProductDetailDetailServices
{
    public class ProductDetailService : IProductDetailService
    {
            ...
            {
                var values = await _ProductDetailCollection.Find<ProductDetail>(ProductDetail => ProductDetail.ProductDetailId == id).FirstOrDefaultAsync();
            ...
            public async Task UpdateProductDetailAsync(UpdateProductDetailDto updateProductDetailDto)
            {
                ...
                await _ProductDetailCollection.FindOneAndReplaceAsync(ProductDetail => ProductDetail.ProductDetailId == updateProductDetailDto.ProductDetailId, values);
            }
        }
}
